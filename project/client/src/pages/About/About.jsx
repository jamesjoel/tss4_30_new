    ...
    <div className="why-choose-section">
		...
		<div className="untree_co-section">
			<div className="container">
				...
				<div className="row">
					...
					<div className="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
						<img src="/public/assets/images/person_1.jpg" className="img-fluid mb-5" />
            ...
            <p className="mb-0"><a href="#" className="more dark">Learn More <span className="icon-arrow_forward"></span></a></p>
					...
					<div className="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
						<img src="/public/assets/images/person_2.jpg" className="img-fluid mb-5" />
            ...
            <p className="mb-0"><a href="#" className="more dark">Learn More <span className="icon-arrow_forward"></span></a></p>
					...
					<div className="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
						<img src="/public/assets/images/person_3.jpg" className="img-fluid mb-5" />
            ...
            <p className="mb-0"><a href="#" className="more dark">Learn More <span className="icon-arrow_forward"></span></a></p>
					...
					<div className="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
						<img src="/public/assets/images/person_4.jpg" className="img-fluid mb-5"/>
